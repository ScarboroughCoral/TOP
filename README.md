...
# utility-types
Personal TypeScript Type Oriented Programming Training..
...
- [Aliases & Type Guards](#aliases--type-guards)
- [Union operators](#union-operators)
- [Object operators](#object-operators)
- [Special operators](#special-operators)
- [Flow's Utility Types](#flows-utility-types)
- [Deprecated API (use at own risk)](#deprecated-api-use-at-own-risk)
  - [`Primitive`](#primitive)
  - [`isPrimitive`](#isprimitive)
  - [`Falsy`](#falsy)
  - [`isFalsy`](#isfalsy)
  - [`SetIntersection<A, B>` (same as Extract)](#setintersectiona-b-same-as-extract)
  - [`SetDifference<A, B>` (same as Exclude)](#setdifferencea-b-same-as-exclude)
  - [`SetComplement<A, A1>`](#setcomplementa-a1)
  - [`SymmetricDifference<A, B>`](#symmetricdifferencea-b)
  - [`NonNullable<A>`](#nonnullablea)
  - [`NonUndefined<A>`](#nonundefineda)
  - [`Exclude<A, B>`](#excludea-b)
  - [`Extract<A, B>`](#extracta-b)
...
- [Flow's Utility Types](#flows-utility-types-1)
  - [`$Keys<T>`](#keyst)
  - [`$Values<T>`](#valuest)
  - [<a id="readonly2"></a> `$ReadOnly<T>`](#-readonlyt)
  - [<a id="diff2"></a> `$Diff<T, U>`](#-difft-u)
